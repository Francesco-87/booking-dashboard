...
function StaffPage() {
  ...
  // Load all staff profiles from the backend
  async function loadStaff() {
    const data = await getStaff()
    setStaff(data)
  }

  // Load staff data when the page opens
  useEffect(() => {
    loadStaff()
  }, [])

  // Create a new staff profile and refresh the list
  async function handleStaffCreate(staffData) {
    await createStaff(staffData)
    await loadStaff()
  }

  // Toggle whether a staff profile is available for booking
  ...
  // Update an existing staff profile and close the edit modal
    ...
    <div className="staff-page">
        ...
        {staff.map((member) => (
          <div key={member.id} className="staff-card">
            <div className="staff-card__header">
              ...
              {/* Status badge reflects whether the performer can be booked */}
              <span
                className={
                  member.isActive
      ...
      {selectedStaff && (
        <div className="staff-edit-modal" onClick={() => setSelectedStaff(null)}>
          <div
            className="staff-edit-modal__content"
          ...
          >
            ...
            {/* Reuse the same form component for staff profile updates */}
            <StaffForm
